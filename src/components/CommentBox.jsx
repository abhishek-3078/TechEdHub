    ...
    return (
        <div className="border-y-2 hover:border-white border-solid my-1 border-transparent ease-in-out duration-300 pl-5 pt-3 mt-2">
            <div className="flex w-100">
                ...
                <p className="text-white text-lg mt-2 ml-2">@DirtyGuy</p>
            </div>
            <div className="flex">
                <p className="text-white">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Nesciunt magnam, at sed aperiam et vel quos ut aliquam perferendis repellat? Quidem commodi quia perferendis ipsum in veritatis minima eos deserunt!</p>
            </div>
